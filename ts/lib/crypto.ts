...
export function createSecretKey(size: any) {
...
export function aesEncrypt(text: any, secKey: any) {
  const _text = text
...
export function zfill(str: any, size: any) {
  while (str.length < size) str = '0' + str
  return str
}

export function rsaEncrypt(text: any, pubKey: any, modulus: any) {
